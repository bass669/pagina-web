document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(API_URL)
        ...
        .then(data => {
            ...
            eventos.forEach(nombreEvento => {
                const evento = data[nombreEvento];
                ...
                evento.images.forEach(url => {
                    const col = document.createElement('div');
                    col.className = 'col-12 col-md-6 col-lg-4 col-xl-3';
                    col.innerHTML = `<div class="galeria-item"><img src="${url}" loading="lazy"></div>`;
                    row.appendChild(col);
                });
            ...
            // 4. Inicializar en "Expogame" automáticamente
            const btnExpogame = Array.from(filterMenu.querySelectorAll('.btn'))
                                    .find(btn => btn.innerText === 'Expogame');
            if (btnExpogame) {
                filterGallery('Expogame', btnExpogame);
            }
